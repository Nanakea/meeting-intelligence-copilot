...
impl RecordingManager {
    ...
    pub async fn save_recording_only<R: tauri::Runtime>(
            ...
            .await
        {
            ...
            Ok(None) => {
                debug!("Transcript-only recording saved successfully");
            }
            Err(e) => {
                error!("Recording save failed");
    ...
    pub async fn stop_recording<R: tauri::Runtime>(
            ...
            .await
        {
            ...
            Ok(None) => {
                info!("Transcript-only recording saved successfully");
            }
            Err(e) => {
                error!("Recording save failed");
                return Err(anyhow::anyhow!(e));
    ...
    pub fn get_recording_save_diagnostics(
        &self,
    ) -> super::recording_saver::RecordingSaveDiagnostics {
        self.recording_saver.get_last_stop_diagnostics()
    }
    ...
    pub fn add_transcript_segment_in_memory(
        &self,
        segment: super::recording_saver::TranscriptSegment,
    ) -> bool {
        self.recording_saver
            .add_transcript_segment_in_memory(segment)
    }
    ...
    pub fn set_meeting_id(&mut self, meeting_id: String) {
        self.recording_saver.set_meeting_id(meeting_id);
    }
