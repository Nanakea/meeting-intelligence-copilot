    ...
    const fetchModelConfig = async () => {
      ...
      try {
        ...
        if (data && data.provider !== null) {
          const localConfig = ['ollama', 'builtin-ai'].includes(data.provider)
            ? data
            : { ...data, provider: 'builtin-ai', model: '', apiKey: null };
          setModelConfig(localConfig);
          data.provider = localConfig.provider;
          data.model = localConfig.model;
          data.apiKey = localConfig.apiKey;
          ...
          <div className="flex space-x-2 mt-1">
            ...
            >
              ...
              <SelectContent className="max-h-64 overflow-y-auto">
                <SelectItem value="ollama">Ollama (loopback only)</SelectItem>
                <SelectItem value="builtin-ai" disabled>Built-in AI (legacy preinstalled models only)</SelectItem>
              </SelectContent>
            </Select>
