...
export function SetupOverviewStep() {
  ...
  return (
    <OnboardingContainer
      ...
      description="Install the local transcription and optional summarization models used by the desktop application."
      step={2}
      ...
      <div className="flex flex-col items-center space-y-10">
        ...
        <div className="w-full max-w-xs space-y-4">
          ...
          <div className="text-center">
            <a
              href="https://github.com/Nanakea/meeting-intelligence-copilot/issues"
              target="_blank"
