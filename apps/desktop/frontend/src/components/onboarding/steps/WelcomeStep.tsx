...
export function WelcomeStep() {
  ...
  const features = [
    ...
    {
      icon: Sparkles,
      title: 'Evidence-backed questions and insights',
    },
    {
      icon: Cpu,
  ...
  return (
    <OnboardingContainer
      title="Welcome to Meeting Intelligence Copilot"
      description="Capture. Understand. Ask the right question. All on your device."
      step={1}
      hideProgress={true}
    >
