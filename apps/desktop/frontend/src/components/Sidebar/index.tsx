...
import { deleteGovernanceMeeting } from '@/services/governanceService';
...
const Sidebar: React.FC = () => {
  ...
  const handleDelete = async (itemId: string) => {
    ...
    try {
      ...
      await deleteGovernanceMeeting(itemId);
      ...
      toast.error("Failed to delete meeting", {
        description: "Local meeting data could not be completely removed. Start the intelligence backend and retry."
      });
    }
  };
