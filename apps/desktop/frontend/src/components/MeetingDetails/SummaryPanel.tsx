...
import type { StoredStructuredIssueDraft } from '@/services/intelligenceIssueDraft';
import { StructuredIssueDraftsDialog } from './StructuredIssueDraftsDialog';
import { MeetingExportButton } from './MeetingExportButton';
import { GovernancePortfolioDialog } from './GovernancePortfolioDialog';
import { SolutionLeadDashboardDialog } from './SolutionLeadDashboardDialog';
...
interface SummaryPanelProps {
  ...
  issueDraft?: StoredMeetingIssueDraft | null;
  structuredIssueDrafts?: StoredStructuredIssueDraft[];
  onStructuredIssueDraftsChanged?: (drafts: StoredStructuredIssueDraft[]) => void;
}
...
export function SummaryPanel({
  ...
  onOpenModelSettings,
  issueDraft,
  structuredIssueDrafts = [],
  onStructuredIssueDraftsChanged = () => undefined,
}: SummaryPanelProps) {
    ...
    <div className="flex-1 min-w-0 flex flex-col bg-white overflow-hidden">
      ...
      <div className="p-4 border-b border-gray-200">
        ...
        <div className="flex flex-wrap items-center justify-center w-full pt-0 gap-2">
          <MeetingExportButton meetingId={meeting.id} />
          <GovernancePortfolioDialog meetingId={meeting.id} />
          <SolutionLeadDashboardDialog />
          {issueDraft && <IssueDraftDialog draft={issueDraft} />}
          <StructuredIssueDraftsDialog
            meetingId={meeting.id}
            records={structuredIssueDrafts}
            transcripts={transcripts}
            onRegenerated={onStructuredIssueDraftsChanged}
          />
