...
import { ArrowLeft, Settings2, Mic, Database as DatabaseIcon, SparkleIcon, FlaskConical, PlugZap } from 'lucide-react';
...
import { ContextConnectorSettings } from '@/components/ContextConnectorSettings';
...
const TABS = [
  ...
  { value: 'connectedContext', label: 'Connections', icon: PlugZap },
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-6xl mx-auto p-8 pt-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="connectedContext">
              <ContextConnectorSettings />
            </TabsContent>
